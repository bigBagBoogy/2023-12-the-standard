...
pragma solidity ^0.8.17; // @audit better use stable version
...
// @audit No natspec anywhere...
contract LiquidationPoolManager is Ownable {
    // q why is this not a uint256?
    uint32 public constant HUNDRED_PC = 100000;

    address private immutable TST; // "The Standard" token
    address private immutable EUROs; // euro stable coin
